    ...
    <section className="bg-white py-12 lg:py-20">
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-8">
          ...
          <button className="w-full sm:w-auto bg-[#0B84FF] hover:bg-[#006FE6] text-white px-8 h-14 rounded-lg font-semibold flex items-center justify-center gap-3 transition duration-300">
            VIEW ALL PRODUCTS
            <FaArrowRight />
          </button>
